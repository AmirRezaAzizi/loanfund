...
return [
    'global' => [
        ...
        'confirmed' => 'نهایی شده',
        'successConfirmAll' => 'همه اسناد واریزی٬ برداشتی و وام ها با موفقیت تایید نهایی شدند و دیگر قابل ویرایش نمی باشند.',
        '' => '',
        '' => '',
        '' => '',
        '' => '',
    ...
    'errors' => [
        ...
        'no_record_in_date' => 'اطلاعاتی جهت نمایش در تاریخ انتخابی وجود ندارد.'
    ],
