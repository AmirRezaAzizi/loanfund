...
@section('page-title')
    <h1 class="h2">ایجاد و ثبت دفترچه پس انداز</h1>
@endsection
    ...
    <form method="POST" action="/customers/{{ $customer->id }}/bankbooks" class="needs-validation" novalidate>
        ...
        <div class="form-row">
            <div class="form-group col-md-5">
                ...
                <input type="number" class="form-control" id="code" value="{{ sprintf("%04d", $customer->code) }}" readonly>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-5">
            ...
            <div class="form-group col-md-5">
                ...
                <input type="text" class="form-control" id="lname" value="{{ $customer->lname }}" readonly>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-5">
                ...
                ‍‍  <input type="number" class="form-control text-left @if ($errors->has('code')) is-invalid @endif" id="code" name="code" required value="{{ old('code', sprintf("%03d", $max_code + 1)) }}">
                    <div class="input-group-prepend">
                        <div class="input-group-text">{{ sprintf("%04d", $customer->code) }}</div>
                    </div>
                </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-5">
                ...
                <div class="input-group mb-2">
                    ‍‍  <input type="number" class="form-control text-left @if ($errors->has('first_balance')) is-invalid @endif" id="first_balance" name="first_balance" required value="{{ old('first_balance') }}">
                    <div class="input-group-prepend">
        ...
        <div class="form-row">
            <div class="col-md-10">
                <button type="submit" class="btn float-left btn-primary btn-lg">ایجاد دفترچه</button>
            </div>
        </div>
        <div class="row my-3">
            <div class="col-10">
