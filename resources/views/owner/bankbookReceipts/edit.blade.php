    ...
    <form method="POST" action="/bankbookReceipts/{{ $bankbookReceipt->id }}" class="needs-validation" novalidate>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-5">
                ...
                <input type="text" class="form-control" id="code" value="{{ $bankbookReceipt->bankbook->customer->id }}/{{ $bankbookReceipt->bankbook->code }}" readonly>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-5">
                <label for="amount">پرداخت</label>
        ...
        <div class="form-row">
            <div class="form-group col-md-5">
                ...
                <div class="input-group mb-2">
                    ‍‍  <input type="text" class="form-control text-left @if ($errors->has('date')) is-invalid @endif" id="date" name="date" required value="{{ old('date', $bankbookReceipt->date) }}" pattern="(?:13|14)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9]||3[0])|(?:(0[1-6])-31))">
                    <div class="input-group-prepend">
